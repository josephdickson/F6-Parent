...
$posts = array( '7739', '7501', '7519', '7736' ); // Order manually by $posts order
...
if ( $the_query->have_posts() ) {
	...
	echo '<h2 class="entry-title" style="margin-top:-1em;padding-left:1rem;display:block;">Spotlights</h2>';
