...
$query = new WP_Query( array( 'post__not_in' => $exclude_ids, 'category_name' => 'spring-2016', 'tag' => 'around-the-mounds' ) ); // pull from category minus exclusion
if ( $query->have_posts() ) : 
?>
...
if ( $image_attributes ) : ?>
	...
	<div class="small-12 columns">
		<span id="Mounds" class="flag serif" style="background:url('<?php echo $image_attributes[0]; ?>') #ffce00 right no-repeat;color:#58595b;height:<?php echo $image_attributes[2]; ?>px;">Around the Mounds</span>
	</div>
