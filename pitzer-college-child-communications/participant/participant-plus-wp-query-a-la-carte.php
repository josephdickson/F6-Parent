...
$query = new WP_Query( array( 'post__not_in' => $exclude_ids, 'category_name' => 'spring-2016', 'tag' => 'a-la-carte' ) ); // pull from category minus exclusion
if ( $query->have_posts() ) : 
?>
...
<div class="row">
	<div class="small-12 columns">
		<span id="Faculty" class="flag serif" style="background:url('<?php echo $image_attributes[0]; ?>') #58595b right no-repeat;color:#fff;height:<?php echo $image_attributes[2]; ?>px;">À la Carte</span>
	</div>
</div>
<?php endif; ?>
