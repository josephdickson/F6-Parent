...
yoast_breadcrumb('<p id="breadcrumbs">','</p>');} ?>
		...
		<?php get_template_part('acf', 'flexible-fields' ); ?>
                ...
                <div class="small-12 large-3 columns menu active accordion-menu small">
		...
		<div class="row">
			<div class="small-12 columns">
				            <p class="extra-small">Last modified by <?php the_modified_author(); ?>, on <?php the_modified_date( $d, $echo ); ?>.</p>
