...
<body <?php body_class(); ?>>
    ...
    <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'galleries-pitzer-college-child' ); ?></a>
...
<section id="content" class="container row" role="document">
